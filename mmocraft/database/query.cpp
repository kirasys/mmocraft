...
namespace database
{
    io::AsyncTask<void> PlayerGamedata::save(const game::Player& player_unsafe)
    {
    ...
    io::AsyncTask<void> PlayerLoginSession::load(std::string_view player_name, database::collection::PlayerLoginSession& session)
    {
